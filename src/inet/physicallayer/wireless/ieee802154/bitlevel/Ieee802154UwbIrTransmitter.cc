...
const ITransmission *Ieee802154UwbIrTransmitter::createTransmission(const IRadio *transmitter, const Packet *packet, const simtime_t startTime) const
{
    ...
    auto transmission = new FlatTransmissionBase(transmitter, packet, startTime, endTime, -1, -1, -1, startPosition, endPosition, startOrientation, endOrientation, packet->getTotalLength(), b(-1), cfg.bitrate, -1, nullptr, -1, cfg.centerFrequency, cfg.bandwidth);
